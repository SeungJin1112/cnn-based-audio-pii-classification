...
### PII 유형 일반화 (v2) — held-out-PII
- 주민번호(rrn)를 **학습에서 전부 제외** → held-out rrn **recall 0.978**.
- in-dist per-PII recall: rrn 0.96 / 계좌 1.0 / 카드 1.0.
- → "숫자 암기"가 아니라 **"PII 형식"을 유형 너머로 일반화**(가장 강한 증거).
